...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main className="min-h-screen flex flex-col items-center justify-center px-6 py-20 md:py-32 pt-32">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="relative">
              <Input
                ...
                className="h-14 rounded-full border-border bg-muted/50 pl-6 pr-14 text-foreground !text-base placeholder:text-muted-foreground"
                disabled={isLoading}
              />
              <Button
                type="submit"
              ...
              >
                {isLoading ? <Loader2 className="size-6 animate-spin" /> : <ArrowRight className="size-6" />}
              </Button>
            </div>
            ...
            <div className="flex flex-wrap gap-2 justify-center min-h-[40px]">
              {isLoading ? (
                <div className="flex items-center gap-2 text-muted-foreground">
                  <span className="text-sm animate-pulse">Finding relevant careers...</span>
                </div>
